        ...
        <div className="embla__container h-full">
          <div className="embla__slide relative">
            ...
            <Image
              ...
              src={"/DesktopCarousel/DSC_1740.jpeg"}
          ...
          <div className="embla__slide relative">
            ...
            <Image
              className="block -z-10"
              style={{ objectFit: "cover" }}
              src={"/DesktopCarousel/DSC_3306.jpeg"}
              alt="Home page background image"
              quality={100}
              priority={true}
              fill={true}
          ...
          <div className="embla__slide relative">
            ...
            <Image
              className="block -z-10"
              style={{ objectFit: "cover" }}
              src={"/DesktopCarousel/DSC_3149 (2).jpeg"}
              alt="Home page background image"
              quality={100}
              priority={true}
              fill={true}
          ...
          <div className="embla__slide relative">
            ...
            <Image
              className="block -z-10"
              style={{ objectFit: "cover" }}
              src={"/DesktopCarousel/DSC_3316.jpeg"}
              alt="Home page background image"
              quality={100}
              priority={true}
              fill={true}
          ...
          <div className="embla__slide relative">
            ...
            <Image
              className="block -z-10"
              style={{ objectFit: "cover" }}
              src={"/DesktopCarousel/DSC_3127 (2).jpeg"}
              alt="Home page background image"
              quality={100}
              priority={true}
              fill={true}
